"""Pydantic models used at API and domain boundaries."""
...
__all__ = ["ValidationResult", "SuggestionUpdate", "RevisionPlanRequest", "JobStepResponse", "SuggestionResponse", "JobResponse"]
